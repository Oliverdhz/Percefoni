									...
									<div class="block2-img wrap-pic-w of-hidden pos-relative block2-labelnew">
										...
										<div class="block2-overlay trans-0-4">
											...
											<div class="block2-btn-addcart w-size1 trans-0-4">
												<!-- Button -->
												<button type="button" class="snipcart-add-item flex-c-m size1 bg4 bo-rad-23 hov1 s-text1 trans-0-4"
												data-item-name="Tu Hermana"
												data-item-price="0.00"
												data-item-id="42"
												data-item-url="https://persefoneshop/product.html">
												 Add to cart
												</button>
											</div>
										</div>
